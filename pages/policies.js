      ...
      desc: () => (
        <>
          <p>
            ...
            で購入された製品を受け取る方法と時間の詳細については、
            <em className="block font-bold">xxx</em>
            注文された製品の配送については、いったん{process.env.site.name}
            の設備を離れると、{process.env.site.name}
            が管理できない様々な事情の影響を受ける可能性があるため、配送の遅れに責任を持つことはできませんが、お客様との協力の下で速やかな配送を実現できるよう、できる限り努力いたします。
          </p>
    ...
    },
    {
      ...
      desc: () => (
        <>
          <p>
            {process.env.site.name}
            でお買い上げいただいた製品について、皆様にご満足いただけるよう、お客様のニーズを満たすような製品を、格別な努力を払って設計・製造していますが、製品がお客様のご期待にそえない場合があるということも承知しています。そうした場合、お客様には以下の製品返品に関する条件をお読みいただくことをおすすめしています。
          </p>
