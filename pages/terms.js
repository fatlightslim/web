    ...
    <Layout {...props}>
      <section className="max-w-2xl mx-auto text-center px-4 py-12">
        ...
        <div className="text-left max-w-xl mx-auto tracking-tight text-xs ">
          ...
          <h2 className="font-bold mt-8 mb-2">第1条（適用）</h2>
          ...
          <h2 className="font-bold mt-8 mb-2">第2条（利用登録）</h2>
          <ol className="list-decimal list-outslide  ml-4">
            <li>
          ...
          <h2 className="font-bold mt-8 mb-2">第4条（売買契約）</h2>
          <ol className="list-decimal list-outside ml-4">
            <li>
          ...
          <h2 className="font-bold mt-8 mb-2">第5条（知的財産権）</h2>
          <p>
          ...
          <h2 className="font-bold mt-8 mb-2">第6条（禁止事項）</h2>
          <p>
          ...
          <h2 className="font-bold mt-8 mb-2">第9条（退会）</h2>
          <p>
          ...
          <h2 className="font-bold mt-8 mb-2">第12条（利用規約の変更）</h2>
          <p>
            当社は、必要と判断した場合には、ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお、本規約の変更後、本サービスの利用を開始した場合には、当該ユーザーは変更後の規約に同意したものとみなします。
          </p>
          <h2 className="font-bold mt-8 mb-2">第13条（個人情報の取扱い）</h2>
          <p>
            当社は、本サービスの利用によって取得する個人情報については、当社「プライバシーポリシー」に従い適切に取り扱うものとします。
          </p>
          <h2 className="font-bold mt-8 mb-2">第14条（通知または連絡）</h2>
          <p>
          ...
          <h2 className="font-bold mt-8 mb-2">第16条（準拠法・裁判管轄）</h2>
          <ol className="list-decimal list-outside ml-4">
            <li>
