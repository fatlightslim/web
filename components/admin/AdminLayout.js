    ...
    <div className="">
      <div className="flex justify-between ">
        <div className="items-center flex">
          ...
          {order && (
            <>
              <span className="uppercase m-4 text-2xl dosis font-bold">
                #{_id.substr(18)}
              </span>
              <span className="align-center inline-flex items-center px-2.5 py-0.5 rounded-md text-sm font-medium bg-green-100 text-green-800">
                <svg
