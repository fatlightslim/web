    ...
    <>
      ...
      <div className="py-24 px-6">
        ...
        <div className="max-w-6xl mx-auto mb-12">
          ...
          <p className="mb-6 text-gray-600 mx-auto max-w-lg text-center leading-relaxed">明るさ、熱調整、消音、電気消費量、値段まで！全ての部門で平均☆4.7点を獲得。「収穫量が十分ではない」「植物が急に弱った」等の原因のほとんどはライトの光量不足によるものです。「植物の元気のために電気代やブレーカー、故障のことは気にせずにライトを当て続けたい」そんな夢が叶う2021年最新版の植物用LEDライトをお届けします。</p>
