    ...
    return (
        ...
        <body class="font-sans font-thin">
            ...
            <div class="w-full h-screen relative text-white">
                <img src="https://cdn.shopify.com/s/files/1/0470/9089/2956/files/91352.jpg?v=1605750211" class="absolute top-0 left-0 w-full h-full object-cover" />

                <header class="z-10 relative mx-auto max-w-6xl px-6 py-8 flex justify-between items-center">

                    <a href="#" class="text-xl tracking-wider">FAT Light SLIM</a>
                ...
                <div class="absolute top-0 left-0 w-full h-full flex justify-center items-center text-center px-12">
                    <div>
                        <h1 class="text-3xl md:text-6xl leading-tight mb-16">世界で一番売れてるライト！<br class="hidden md:block" />MARS HYDRO</h1>
                        <a href="https://web-7apx08vo7.vercel.app/en/products" class="border border-white py-4 px-8 hover:bg-white hover:text-black">Now on Sale!</a>
                    </div>
                </div>
            ...
            <div class="py-24 px-6">
                ...
                <div class="max-w-5xl mx-auto flex flex-wrap items-start">
                    ...
                    <div class="w-full md:w-1/2 p-4 mb-12">
                        <img src="https://cdn.shopify.com/s/files/1/0470/9089/2956/files/2062.jpg?v=1605753164" class="block w-full h-auto mb-12" />
                        <a href="#" class="block text-2xl text-black text-center mb-6">収穫量にきっとビックリします</a>
                        <p class="mb-6 text-gray-600 text-center leading-relaxed text-sm">太陽光のような心地よい光は植物の光合成をバッチリサポート！生き生きと日々成長するハーブや野菜を育てて、収穫の楽しさを味ってみるのはいかがでしょう！</p>
                        <a href="#" class="block text-black text-center">Read more</a>
                    </div>

                    <div class="w-full md:w-1/2 p-4 mb-12">
                        <img src="https://cdn.shopify.com/s/files/1/0470/9089/2956/files/1613.jpg?v=1605752742" class="block w-full h-auto mb-12" />
                        <a href="#" class="block text-2xl text-black text-center mb-6">電気代がこんなにおトク</a>
