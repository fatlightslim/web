...
// }) {
//   return (
//     <div className="bg-yellow-100 p-2 md:px-40 md:py-12 min-h-full">
//       <h3 className="text-6xl text-center font-extrabold"></h3>
...
//             <span className="text-green-400">{data.prompt}</span>
