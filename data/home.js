    ...
    h2: {
      ...
      desc: () => (
        <>明るさ、熱調整、消音、電気消費量、値段まで！全ての部門で平均
          ...
          4.7点を獲得。「収穫量が十分ではない」「植物が急に弱った」等の原因のほとんどはライトの光量不足によるものです。「植物の元気のために電気代やブレーカー、故障のことは気にせずにライトを当て続けたい」そんな夢が叶う2020年最新版の植物用LEDライトをお届けします。</>
      ),
    },
    h3: [
      {
      ...
      },
      {
        title: "電気代がこんなにおトク",
        desc:
          "明るいライトだったらやっぱり電気代が心配！MARS HYDRO製品なら最新のLEDチップ搭載&ファンレス構造で電気料金の最大20%OFFが実現しました。ファンがないため24時間静かな環境で栽培を楽しむことができます。",
        img: {
